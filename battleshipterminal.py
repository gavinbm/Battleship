...
# I migrated this to work on a flask app as of 11/24/2020
# To Run just enter the command: python "battleshipterminal.py"
# Check out my github for my other projects: https://github.com/gavinbm
